...
(d=0)):"Primero"==b?d=0:"Anterior"==b?(d=0<=e?d-e:0,0>d&&(d=0)):"Siguiente"==b?d+e<f&&(d+=e):"Ultimo"==b?d=Math.floor((f-1)/e)*e:K(a,0,"Unknown paging action: "+b,5);b=a._iDisplayStart!==d;a._iDisplayStart=d;b&&(s(a,null,"page",[a]),c&&O(a));return b}function sb(a){return h("<div/>",{id:!a.aanFeatures.r?a.sTableId+"_processing":null,"class":a.oClasses.sProcessing}).html(a.oLanguage.sProcessing).insertBefore(a.nTable)[0]}function C(a,b){a.oFeatures.bProcessing&&h(a.aanFeatures.r).css("display",b?"block":"none");
...
" ui-corner-tl ui-corner-tr",sJUIFooter:Yb+" ui-corner-bl ui-corner-br"});var Nb=m.ext.pager;h.extend(Nb,{simple:function(){return["Anterior","Siguiente"]},full:function(){return["Primero","Anterior","Siguiente","Ultimo"]},numbers:function(a,b){return[ia(a,b)]},simple_numbers:function(a,b){return["Anterior",ia(a,b),"Siguiente"]},full_numbers:function(a,b){return["Primero","Anterior",ia(a,b),"Siguiente","Ultimo"]},first_last_numbers:function(a,b){return["Primero",ia(a,b),"Ultimo"]},_numbers:ia,numbers_length:7});h.extend(!0,m.ext.renderer,
{pageButton:{_:function(a,b,c,d,e,f){var g=a.oClasses,j=a.oLanguage.oPaginate,i=a.oLanguage.oAria.paginate||{},m,l,p=0,r=function(b,d){var k,t,u,s,v=function(b){Va(a,b.data.action,true)};k=0;for(t=d.length;k<t;k++){s=d[k];if(h.isArray(s)){u=h("<"+(s.DT_el||"div")+"/>").appendTo(b);r(u,s)}else{m=null;l="";switch(s){case "ellipsis":b.append('<span class="ellipsis">&#x2026;</span>');break;case "Primero":m=j.sFirst;l=s+(e>0?"":" "+g.sPageButtonDisabled);break;case "Anterior":m=j.sPrevious;l=s+(e>0?"":" "+
